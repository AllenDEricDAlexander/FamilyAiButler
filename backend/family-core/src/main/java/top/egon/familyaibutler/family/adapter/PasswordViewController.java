...
import top.egon.familyaibutler.family.adapter.assembler.PasswordViewWebAssembler;
import top.egon.familyaibutler.family.application.PasswordViewServiceI;
...
public class PasswordViewController {
    ...
    public PageResult<List<PasswordViewPO>> selectAll(@PathVariable(value = "pageNum", required = false) @Range(min = 1) Integer pageNum,
        ...
        Page<PasswordViewPO> page = passwordViewService.page(query);
