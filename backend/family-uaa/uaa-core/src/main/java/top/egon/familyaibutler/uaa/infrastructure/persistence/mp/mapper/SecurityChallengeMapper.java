 ...
 * @FileName: SecurityChallengeMapper.java
 * @Author: atluofu
 * @CreateTime: 2026Year-05Month-20Day-14:25
 * @Description: 安全挑战数据库访问层文件
 * @Version: 1.0
 */
 ...
 * @BelongsProject: familyaibutler
 * @BelongsPackage: top.egon.familyaibutler.uaa.infrastructure.persistence.mp.mapper
 * @ClassName: SecurityChallengeMapper
 * @Author: atluofu
 * @CreateTime: 2026-05-20 14:25
 * @Description: 安全挑战数据库访问层
 * @Version: 1.0
 */
@Mapper
public interface SecurityChallengeMapper extends BaseMapper<SecurityChallengePO> {
}
