 ...
 * @FileName: ProfileServiceImpl.java
 * @Author: atluofu
 ...
 */
@Service
public class ProfileServiceImpl implements ProfileServiceI, ProfileFacade {
     ...
     */
    public ProfileServiceImpl(AccountGateway accountGateway, ProfileGateway profileGateway) {
