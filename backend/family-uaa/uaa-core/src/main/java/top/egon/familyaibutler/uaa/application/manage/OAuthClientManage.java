 ...
 * @FileName: OAuthClientManage.java
 * @Author: atluofu
 * @CreateTime: 2026Year-05Month-20Day-16:45
 * @Description: OAuth Client 应用服务接口文件
 * @Version: 1.0
 */
 ...
 * @BelongsProject: familyaibutler
 * @BelongsPackage: top.egon.familyaibutler.uaa.application.manage
 * @ClassName: OAuthClientManage
 * @Author: atluofu
 * @CreateTime: 2026-05-20 16:45
 * @Description: OAuth Client 应用服务接口
 * @Version: 1.0
 */
public interface OAuthClientManage {
