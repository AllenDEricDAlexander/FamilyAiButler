 ...
 */
@Service
public class RbacServiceImpl implements RbacServiceI {
     ...
     */
    public RbacServiceImpl(RbacGateway rbacGateway) {
    ...
    public PermissionResourceResponse upsertResource(UpsertPermissionResourceRequest request) {
        PermissionResource resource = PermissionResource.active(request.resourceCode(), request.resourceName(),
                top.egon.familyaibutler.uaa.domain.model.enums.PermissionResourceType.valueOf(request.resourceType().name()),
