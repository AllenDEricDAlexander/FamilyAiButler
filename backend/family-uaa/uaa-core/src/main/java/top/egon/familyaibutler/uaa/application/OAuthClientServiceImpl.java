 ...
 * @FileName: OAuthClientServiceImpl.java
 * @Author: atluofu
...
import top.egon.familyaibutler.uaa.domain.model.enums.OAuthClientStatus;
 ...
 */
@Service
public class OAuthClientServiceImpl implements OAuthClientServiceI {
     ...
     */
    public OAuthClientServiceImpl(OAuthClientGateway oAuthClientGateway, TokenDomainService tokenDomainService) {
