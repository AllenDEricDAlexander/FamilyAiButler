 ...
 * @FileName: AccountManageImpl.java
 * @Author: atluofu
...
public class AccountManageImpl implements AccountManage {
     ...
     */
    public AccountManageImpl(AccountCommandExe accountCommandService, AccountQueryExe accountQueryService) {
     ...
     * @return 账号摘要
     */
    private AccountSummaryResponse toSummary(top.egon.familyaibutler.uaa.domain.account.model.aggregate.Account account) {
