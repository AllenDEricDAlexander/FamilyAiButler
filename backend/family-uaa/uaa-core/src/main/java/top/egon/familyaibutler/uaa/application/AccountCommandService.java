 ...
 * @FileName: AccountCommandService.java
 * @Author: atluofu
 ...
 * @BelongsProject: familyaibutler
 * @BelongsPackage: top.egon.familyaibutler.uaa.application
 * @ClassName: AccountCommandService
 * @Author: atluofu
...
public class AccountCommandService {
     ...
     */
    public AccountCommandService(AccountDomainService accountDomainService, CredentialDomainService credentialDomainService,
