...
public class TokenManageImpl implements TokenManage {
     ...
     */
    public TokenManageImpl(TokenGateway tokenGateway, SessionGateway sessionGateway, TokenDomainService tokenDomainService,
