 ...
 */
@Service
public class AuthServiceImpl implements AuthServiceI, AuthFacade {
     ...
     */
    public AuthServiceImpl(AccountGateway accountGateway, CredentialGateway credentialGateway, DeviceGateway deviceGateway,
